...
finer grained control over the units of change, approaches similar to this one have already been explored in previous literature
...
The remainder of this section will try to formalise the intuition presented 
...
actual code, the diff algorithm, which is employed by most VCS when trying to 
...
postponed in favour of exploring the optimisations.
